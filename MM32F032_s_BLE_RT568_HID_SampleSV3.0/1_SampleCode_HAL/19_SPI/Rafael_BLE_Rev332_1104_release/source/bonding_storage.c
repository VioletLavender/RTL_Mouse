...
extern void flash_erase_internal_use(uint32_t u32Addr);
    ...
    case CMD_FB_GET_DATA_FLASHBOND_EXST_PBID_DBLK_START:
        *para_data = FLH_BND_ERR_CODE_NO_ERR;
        ...
        else
        {
            ...
            *(para_data+TAB_PARA_DATA_PID) = (i*NUM_OF_FLASH_PAGE_FOR_BONDING_DAT_GRP_BLK)+(NUM_OF_DAT_GRP_BLK_ONE_PAGE-1-x) ;
